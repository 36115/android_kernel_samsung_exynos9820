...
static int __init proc_cmdline_init(void)
{
	...
	process_flag(FLAG_REPLACE, "ro.crypto.state=", "encrypted"); // Encrypted Status
	process_flag(FLAG_REPLACE, "sys.oem_unlock_allowed=", "0"); // Reset oem unlock toggle to disable
